---
title: "Oh My Zsh + Powerlevel10k Setup Guide for Linux"
description: "Install and configure Oh My Zsh with Powerlevel10k theme, autosuggestions, and syntax highlighting on Ubuntu/Debian. Includes tmux integration and full dotfile config."
...
<HowToSchema
  name="Oh My Zsh + Powerlevel10k Setup for Linux"
  description="Install and configure Oh My Zsh with Powerlevel10k theme, autosuggestions, and syntax highlighting on Ubuntu/Debian."
  steps={[
    { name: "Install Zsh", text: "Install Zsh using your package manager (apt install zsh) and set it as your default shell with chsh." },
    { name: "Install Oh My Zsh", text: "Run the Oh My Zsh install script to set up the Zsh framework with plugin and theme management." },
    { name: "Install Powerlevel10k theme", text: "Clone the Powerlevel10k repository into the Oh My Zsh custom themes directory and set ZSH_THEME in .zshrc." },
    { name: "Install plugins", text: "Add zsh-autosuggestions and zsh-syntax-highlighting plugins to your Oh My Zsh configuration." },
    { name: "Configure tmux", text: "Install and configure tmux for terminal multiplexing and session management." }
  ]}
/>
