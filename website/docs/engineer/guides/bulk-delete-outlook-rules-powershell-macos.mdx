...
PowerShell isn't Windows-only anymore. Install via Homebrew — the same package manager used in other [Mac-adjacent dev environment guides](/docs/engineer/guides/chomebook-terminal):
