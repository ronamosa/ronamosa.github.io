...
- The CLOUD Act is an important step forward, but now more steps need to follow - Microsoft

### Learning

*Things I’m actively studying or learning this week…*

- (still) Studying for the‘AWS Certified Security - Speciality’certificate.

### Building

*Things I’m building or working on this week…*

- I didn’t work on myYouTube Analyzerproject last week but I did build this‘Discord ChatGPT Bot’for the PTN Discord Server.

- Work through a fewWell-Architected Labsthis week.

### Interesting Reads

*Articles or other writing that stood out to me this week…*

- ‘Architects, Anti-Patterns, and Organizational Fuckery’- by Charity Majors

- ‘Architecture is everyone's business‘- by Christian Uhl
