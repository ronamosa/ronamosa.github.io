...
ChatGPT is an AI chatbot developed by OpenAI and built on top of OpenAI’s GPT3 family of “Large Language Models” (**LLM**) and fine tuned using supervised and reinforcement learning techniques[1](#footnote-1).
...
AI brings a whole other dimension to that. Dan McQuillan in his piece'We Come to Bury ChatGPT, Not to Praise It.'[2](#footnote-2)talks about how OpenAI CEO Sam Altman thinks of people as 'stochastic parrots' - meaning people are just large language models with learned patterns of behaviour and nothing more (yes, paraphrasing and simplifying). It's an idea seemingly only applied to us ordinary folk, and the "elites" of our society are apparently something better. So of course, us "ordinary folk" are perfect fodder to feed the AI machine meant to serve the upper class withfree training labourfor Google’s reCAPTCHA to train their models.
