...
That’s the weird[1](#footnote-1).

The wonderful is (and I will do a proper post and share of it at some stage) getting myPe’a. I took some time off in July (almost a month), to receive this and heal up before getting back to work this month.
...
I’ve thought about it for a while for variousreasons, and also wanted something that was just email based.
