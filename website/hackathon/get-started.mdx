...
3. Paste `http://localhost:3000` and press Enter.

The browser opens as a tab next to your code. Now when Kiro changes something, just refresh the Simple Browser tab and watch your app update live. Keep **Chrome** open too — that's where you'll run your final pitch demo.
