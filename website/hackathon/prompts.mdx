...
1. Open your starter project in Kiro (see [Hackathon Day Guide → Section 5](/hackathon/get-started#build-with-kiro)).
...
:::tip Earlier in the day? Use Kiro Chat for research, not just code
Before you build, use Kiro Chat to dig into your problem — see [Research Prompts](#-research-prompts-empathise--ideate) below for examples to copy.
:::
...
## 🔎 Research Prompts (Empathise & Ideate)

Kiro Chat isn't only for code. During the **Empathise** and **Ideate** stages, use it as your **primary research tool** — to learn about the problem, find example facts, compare existing solutions, and stress-test your ideas. The same "be specific" rule applies.

:::warning Always sanity-check what comes back
Kiro can sound confident and still be wrong. Ask *"What sources are you using?"*, cross-check with your facilitator, and never put a stat in your pitch you can't back up. See [Trustworthy AI → Check what the AI tells you](/hackathon/get-started#trustworthy-ai).
:::

### Understand your problem

```text
Explain the main causes of plastic pollution on New Zealand beaches in
language a 14-year-old would understand. Give me 5 short facts and tell
me where each one comes from.
```

```text
Who is most affected by food insecurity among rangatahi in Aotearoa, and
why? Summarise from real NZ research and list the sources you used.
```

### Build a richer persona

```text
Help me build a persona for a 14-year-old in South Auckland who's worried
about water quality at her local beach. Suggest her daily routine, what
she'd want from an app, and what would frustrate her about existing
council websites.
```
...
```text
What apps or tools already exist for tracking native species sightings
in Aotearoa? Compare 2 or 3 of them — what they do well, what's missing,
and what a school team could do differently.
```

### Pressure-test your idea

```text
We want to build a daily mood check-in app for Year 9 students. What are
the biggest risks or downsides we should think about? What would make
...
wants to know if her local beach is safe to swim at. Mix realistic ideas
with a couple of wild ones.
```

:::tip Bring research into your pitch
A pitch that says *"We asked Kiro about food waste in NZ schools, found that X tonnes goes to landfill each year, then we checked it against the Ministry's report"* is gold for judges. It shows curiosity, AI use, **and** verification.
:::
