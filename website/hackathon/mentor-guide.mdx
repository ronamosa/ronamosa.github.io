...
| 🎯 Icebreaker & problem exploration (9:40) | Run the Icebreaker with energy; help teams explore the problem list and land on one they care about. **Push them into Kiro Chat for primary research** — questions like *"What are the main causes of [problem] in NZ?"* — and reinforce checking what it says. Push personas toward specifics |
| 💡 Ideation (10:25) | Quick, kind feedback on top ideas — push teams to **shrink scope**. Encourage Kiro Chat as a brainstorming partner (e.g. *"Give me 10 How Might We questions for Mere"*) |
...
Vague prompts are the #1 reason students get bad results from Kiro. The same coaching applies whether they're asking Kiro to **build code** or **research a problem** — be specific.

Help them by asking three questions:
...
| "Tell me about food waste" | "Give me 5 facts about food waste in NZ schools, sourced from real research, that a 14-year-old would understand" |

:::tip Two-tries rule
If Kiro hasn't fixed something after 2 attempts, pause and rethink the prompt — don't burn 15 minutes wrestling.
:::

### Coaching research prompts

When students use Kiro Chat for **research** (during Empathise and Ideate), nudge them toward better questions and toward **verifying** what comes back:

- *"Ask Kiro what sources it used. Are they real? Can you find them?"*
- *"That's a confident answer — does it match what your facilitator shared?"*
- *"Try asking the same question a different way and see if the answer holds up."*
- If Kiro invents a fact, treat it as a teachable moment. Calling out a hallucination together is one of the most useful things they'll do today.
...
- If a team quotes a "fact" from Kiro (whether it came from research or a build prompt), ask *"where did that come from — did you check it?"*
...
- Nudge teams to plan **one sentence in their pitch** about how they used Kiro — including how they used Kiro Chat to research the problem. It's an easy judges win.
